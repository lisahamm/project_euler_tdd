...
module ProjectEuler
  describe ProblemEleven do
    ...
    let (:twenty_by_twenty_array) {ProblemEleven.format_number(
    ...
    it "returns the largest product of the combinations of 4 adjacent items" do
      combinations = ProblemEleven.adjacent_items_left(twenty_by_twenty_array)
      combinations += ProblemEleven.adjacent_items_down(twenty_by_twenty_array)
      combinations += ProblemEleven.adjacent_items_diagonal_down(twenty_by_twenty_array)
      combinations += ProblemEleven.adjacent_items_diagonal_up(twenty_by_twenty_array)
      expect(combinations.first).to eq [8,2,22,97]
      expect(ProblemEleven.largest_product(combinations)).to eq 70600674
    end
