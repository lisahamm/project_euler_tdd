...
module ProjectEuler
  describe ProblemEight do
    ...
    it "returns the sequence of a given length with the largest product in a number" do
      expect(ProblemEight.sequence_with_largest_product(n,13)).to eq 5576689664895
    end

    it "returns the sequence of a given length with the largest product in a number" do
      expect(ProblemEight.largest_product_of_sequence_digits(n,4)).to eq 5832
    end

    it "returns the sequence of a given length with the largest product in a number" do
      expect(ProblemEight.largest_product_of_sequence_digits(n,13)).to eq 23514624000
    end
  end
end